...
import { a as buildAssetsURL, z as publicAssetsURL, D as useRuntimeConfig, n as getResponseStatusText, m as getResponseStatus, i as encodePath, e as defineRenderHandler, l as getQuery, c as createError, h as destr, o as getRouteRules, u as joinURL, C as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"A mobile-first symptom tracker for veterans to log symptoms, track daily impact, and collect supporter observations."},{"name":"viewport","content":"width=device-width, initial-scale=1, viewport-fit=cover"},{"name":"theme-color","content":"#0f172a"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"},{"name":"apple-mobile-web-app-title","content":"Symptoms"},{"property":"og:title","content":"Veteran Symptom Tracker"},{"property":"og:description","content":"Track symptoms, daily impact, and signed supporter observations from your phone."},{"property":"og:type","content":"website"},{"property":"og:image","content":"/pwa-512.png"},{"name":"twitter:card","content":"summary"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/icon.svg"},{"rel":"icon","type":"image/png","sizes":"48x48","href":"/favicon-48.png"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"}],"style":[],"script":[],"noscript":[],"title":"Veteran Symptom Tracker"};
